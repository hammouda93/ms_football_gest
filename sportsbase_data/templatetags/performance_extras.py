...
PERFORMANCE_COPY = {
    "fr": {
        ...
        "average_index": "Index moyen",
        "analysed_matches_reference": "Sur les matchs analysés",
        "analysed_total": "Total analysé",
        "minutes_analysed": "Minutes analysées",
        "minutes_per_match": "min par match",
        "ms_season_analysis": "Saison MS Performance",
        "tracked_season_help": "Calcul mis à jour après chaque rencontre analysée : total réel, moyenne par match et efficacité pondérée par les tentatives.",
        "position_reference": "Missions du poste",
        "season_position_missions": "Bilan des missions sur la saison",
        "match_samples": "match(s) analysé(s)",
        "mission_weight": "poids",
        "all_tracked_kpis": "Tous les KPI des matchs analysés",
        "indicator": "Indicateur",
        "external_season_reference": "Référence saison complète",
        "source_season_statistics": "Statistiques générales de la saison",
        "source_season_help": "Ces repères couvrent la saison complète. Ils restent séparés des calculs MS Performance établis uniquement à partir des matchs analysés.",
        "per_match": "par match",
    ...
    "en": {
        ...
        "average_index": "Average index",
        "analysed_matches_reference": "Across analysed matches",
        "analysed_total": "Analysed total",
        "minutes_analysed": "Minutes analysed",
        "minutes_per_match": "min per match",
        "ms_season_analysis": "MS Performance season",
        "tracked_season_help": "Updated after every analysed match: actual total, per-match average and success rates weighted by attempts.",
        "position_reference": "Position missions",
        "season_position_missions": "Season mission review",
        "match_samples": "analysed match(es)",
        "mission_weight": "weight",
        "all_tracked_kpis": "All KPIs from analysed matches",
        "indicator": "Indicator",
        "external_season_reference": "Full-season reference",
        "source_season_statistics": "General season statistics",
        "source_season_help": "These reference points cover the full season and remain separate from MS Performance calculations based only on analysed matches.",
        "per_match": "per match",
    ...
    "ar": {
        ...
        "average_index": "متوسط المؤشر",
        "analysed_matches_reference": "ضمن المباريات المحللة",
        "analysed_total": "المجموع المحلل",
        "minutes_analysed": "الدقائق المحللة",
        "minutes_per_match": "دقيقة في المباراة",
        "ms_season_analysis": "موسم MS Performance",
        "tracked_season_help": "يتم التحديث بعد كل مباراة محللة: المجموع الفعلي، معدل المباراة ونسب النجاح الموزونة بعدد المحاولات.",
        "position_reference": "مهام المركز",
        "season_position_missions": "حصيلة مهام المركز خلال الموسم",
        "match_samples": "مباراة محللة",
        "mission_weight": "الوزن",
        "all_tracked_kpis": "كل مؤشرات المباريات المحللة",
        "indicator": "المؤشر",
        "external_season_reference": "مرجع الموسم الكامل",
        "source_season_statistics": "الإحصائيات العامة للموسم",
        "source_season_help": "تشمل هذه المؤشرات الموسم الكامل وتبقى منفصلة عن حسابات MS Performance المبنية فقط على المباريات المحللة.",
